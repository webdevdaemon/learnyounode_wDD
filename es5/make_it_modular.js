...
function caller(err, data) {
    if (err) { console.log("error: " + err); // if error value is present, log an error...
        return; } // ...and terminate function immediately
    data.map(function(input) { // map through data (array)...
